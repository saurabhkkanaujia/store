                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form enctype="multipart/form-data" action="../index.php" class="checkout" method="post" name="checkout">

                                <div id="customer_details" class="col2-set">
                                    <div class="col-3">
                                        <div class="woocommerce-billing-fields">
                                            <h3>Billing Details</h3>
                                            <p id="billing_country_field" class="form-row form-row-wide address-field 
                                                    update_totals_on_change validate-required woocommerce-validated">
                                    ...
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($productArr as $key => $value) {
                                                echo '<tr class="cart_item">
                                                    ...
                                                    ' . $value[0]['name'] . '  <strong class="product-quantity">
                                                        x ' . $value[1] . '</strong> </td>
                                                    <td class="product-total">
                                                        <span class="amount">₹' . $value[0]['price'] * $value[1] . '</span>
                                                    </td>
                                                    </tr>';
                                            }
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">₹<?php echo totalSum($productArr); ?></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">₹<?php echo totalSum($productArr); ?>
                                                        </span></strong> </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            <li class="payment_method_bacs">
                                                <input type="radio" data-order_button_text="" checked="checked" value="credit" name="payment_method" class="input-radio" id="payment_method_bacs">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" name="cardExpiry" id="cc-expiration" placeholder="" required>
                                            ...
                                            <li class="payment_method_paypal">
                                                ...
                                                <label for="payment_method_paypal">PayPal <img alt="PayPal Acceptance Mark" src="https://www.paypalobjects.com/webstatic/mktg/Logo/AM_mc_vs_ms_ae_UK.png"><a title="What is PayPal?" onclick="javascript:window.open('https://www.paypal.com/gb/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;" class="about_paypal" href="https://www.paypal.com/gb/webapps/mpp/paypal-popup">What
                                                        is PayPal?</a>
                                                </label>
