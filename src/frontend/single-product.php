                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="product-breadcroumb">
                            <a href="">Home</a>
                            <a href=""><?php echo $productArr[0]['category']; ?></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name"><?php echo $productArr[0]['name']; ?></h2>
                                    ...
                                    <form action="../index.php" method="POST" class="cart">
                                        ...
                                        <button class="add_to_cart_button" type="submit" name="action" value="addToCart">Add to cart</button>
                                    </form>

                                    <div class="product-inner-category">
                                        <p>Category: <a href=""><?php echo $productArr[0]['category']; ?></a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div>
