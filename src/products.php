...
$prodArr = $fetchObj->fetchProducts();
?>
<!doctype html>
<html lang="en">
            ...
            <tbody>
              ...
              foreach ($prodArr as $key => $value) {
                echo "<tr>
                  ...
                  <td>" . $value['price'] . "</td>
                  <td><button class = 'btn btn-primary' type='submit' name = 'editProd' value=".$value['id'].">Edit</button> <button class = 'btn btn-danger' type='submit' name = 'deleteProd' value = ".$value['id'].">Delete</button></td>";
              }
              ?>
            </tbody>
          </table>
